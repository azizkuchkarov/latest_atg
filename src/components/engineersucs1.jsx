...
const resources = [
  {
    href: '/ucs1/engineers#liu-wei',
    name: 'Liu Wei',
    description: `"Начальник UCS-1 /  
      UCS-1 Manager"`,
    link: user,
    flag: china,
    pattern: {
  ...
  {
    href: '/ucs1/engineers#rustam-ganiev',
    name: `Rustam Ganiev`,
    description: `"Заместитель начальника UCS-1 / UCS-1 Deputy Manager" `,
    link: user,
    flag: uzb,
    pattern: {
      y: 16,
  ...
  {
    href: '/ucs1/engineers#ding-zhenjun',
    name: `Ding Zhenjun`,
  ...
  {
    href: '/ucs1/engineers#uktam-buronov',
    name: 'Uktam Buronov',
  ...
  {
    href: '/ucs1/engineers#yarash-uzokov',
    name: `Yarash Uzokov`,
  ...
  {
    href: '/ucs1/engineers#samad-djuraev',
    name: 'Samad Djuraev',
    description: `"Инженер КИПиА
      Automatic Equipments System Engineer "
      `,
  ...
  {
    href: '/ucs1/engineers#kenjaev-utkur',
    name: 'Kenjaev Utkur',
  ...
  {
    href: '/ucs1/engineers#yan-rongzhang',
    name: 'Yan Rongzhang',
    description: `"Инженер - электрик
    Electrical Engineer"
      `,
  ...
  {
    href: '/ucs1/engineers#nosir-karimov',
    name: 'Nosir Karimov',
  ...
  {
    href: '/ucs1/engineers#sadriddin-saidov',
    name: 'Sadriddin Saidov',
  ...
  {
    href: '/ucs1/engineers#roman-dinikeev',
    name: 'Roman Dinikeev',
    description: `"Сменный инженер
      Shift Engineer"
      `,
  ...
  {
    href: '/ucs1/engineers#ulugbek-shadiev',
    name: 'Ulugbek Shadiev',
    description: `"Сменный инженер
      Shift Engineer"
      `,
    flag: uzb,
  ...
  {
    href: '/ucs1/engineers#obid-sharopov',
    name: 'Obid Sharopov',
    description: `"Сменный инженер
      Shift Engineer"
      `,
  ...
  {
    href: '/ucs1/engineers#talgat-rakhmatullin',
    name: 'Talgat Rakhmatullin',
    description: `"Сменный инженер
      Shift Engineer"
      `,
    flag: uzb,
  ...
  {
    href: '/ucs1/engineers#shavkatjon-kholikov',
    name: 'Shavkatjon Kholikov',
    description: `"Сменный инженер
      Shift Engineer"
      `,
    flag: uzb,
  ...
  {
    href: '/ucs1/engineers#timur-kurbanov',
    name: 'Timur Kurbanov',
    description: `"Сменный инженер
      Shift Engineer"
      `,
